...
class DeliveryItemAdapter(private val context: Context, var list: ArrayList<PurchaseRequestModel.StockTransferLines>, private val networkConnection: NetworkConnection,
                          private val materialProgressDialog: MaterialProgressDialog, private val callback: AdapterCallback, private val save: Chip, private val
                              selectedSaleToDeliveryType:String) : RecyclerView
                                  .Adapter<DeliveryItemAdapter.ViewHolder>(), BatchItemsAdapter.OnDeleteItemClickListener {

    //todo declaration..
    private val binLocation= mutableListOf<ModelBinLocation>()

    private lateinit var adapterFields: DynamicFieldDeliveryAdapter
...
//        setSqlServer()
    ...
    /*    fun onApiResponseStock(
        ...
        fun onApiResponseStock(response: java.util.HashMap<String, ArrayList<ScanedOrderBatchedItems.Value>>,
            list: ArrayList<PurchaseRequestModel.StockTransferLines>, quantityResponse: HashMap<String, ArrayList<String>>, serialQuantityResponse: HashMap<String, ArrayList<String>>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        with(holder) {
            with(list[position]) {
                ...
                val staticValue = DeliveryDraftDocumentLinesActivity.staticString
...
//                            pos = adapterPosition
                ...
                save.setOnClickListener {
                    if(binding.edBatchCodeScan.text.equals("0.0")){
                        ...
                        DeliveryDraftDocumentLinesActivity.staticString = binding.edBatchCodeScan.text.toString()
                       /* for (i in 0 until list.size) {
...
//                                                    val mapValue = listCopy.firstOrNull()?.toDoubleOrNull()?.toInt()
                                                ...
                                                batchItemsAdapter?.setOnDeleteItemClickListener(this@DeliveryItemAdapter)
                                                rvBatchItems.adapter = batchItemsAdapter
...
//                            }
    ...
    private fun setFieldAdapters(context: Context,rvDynamicField: RecyclerView, binLocationList: List<String>,scanType:String,binManaged:String,binAbs: List<String>) {
        rvDynamicField.apply {
            ...
            adapterFields = DynamicFieldDeliveryAdapter(context,binLocationList,binAbs,
                binLocation,
