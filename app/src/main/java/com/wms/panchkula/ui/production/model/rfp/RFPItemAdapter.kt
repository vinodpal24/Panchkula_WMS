...
import com.wms.panchkula.ui.production.adapter.rfp.DynamicFieldRFPAdapter
...
class RFPItemAdapter(
    ...
    var serialQuantityHashMap: HashMap<String, ArrayList<String>> =
        HashMap<String, ArrayList<String>>()
    var noneQuantityHashMap: HashMap<String, ArrayList<String>> =
        HashMap<String, ArrayList<String>>()
...
//        setSqlServer()
    ...
    interface AdapterCallback {
        ...
        fun onApiResponseStock(
            ...
            list: ArrayList<RFPResponse.Value>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        with(holder) {
            with(list[position]) {
                ...
                binding.tvOpenQtyLabel.text = "RFP Qty"
                ...
                val staticValue = RFPLinesActivity.staticString
...
//                tvTotalScanGW = binding.tvTotalScanGw
                ...
                binding.tvTotalScanGw.text = this.ItemType
                ...
                binding.mainCard.setOnClickListener {
                    ...
                    Log.e("RFP_ITEM", "WarehouseCode: ${this.WarehouseCode}")
                    openDynamicFieldsDialog(
                        context,
                        position,
                            ...
                            if (text.isNotEmpty()) {
                                try {
                                    ...
                                    if (checkDuplicate(hashMap.get("Item" + position)!!, batch)) {
                                        ...
                                        var binAllocationJSONs = RFPResponse.binAllocationJSONs(
                                            "",
                                            text.split(",")[2],
                                            list[position].Quantity,
                                            text.split(",")[0],
  ...
  */
                                    ...
                                    Handler(Looper.getMainLooper()).postDelayed({
                                        ...
                                        imm?.hideSoftInputFromWindow(
                                            binding.edBatchCodeScan.windowToken,
                                            0
                                        )
                                    }, 200)
                                } catch (e: Exception) {
                ...
                else if (sessionManagement.getScannerType(context) == "QR_SCANNER" || sessionManagement.getScannerType(
                        context
                    ) == null
...
//                            pos = adapterPosition
                            pos = setScanDataOnItem(list, list.get(adapterPosition).ItemNo)
                ...
                save.setOnClickListener {
                    if (binding.edBatchCodeScan.text.equals("0.0")) {
                        ...
                        RFPLinesActivity.staticString = binding.edBatchCodeScan.text.toString()
                        /* for (i in 0 until list.size) {
    ...
    var hashMapBatchList: java.util.HashMap<String, ArrayList<ScanedOrderBatchedItems.Value>> =
        java.util.HashMap<String, ArrayList<ScanedOrderBatchedItems.Value>>()
    var hashmapBatchQuantityList: java.util.HashMap<String, ArrayList<String>> =
...
//                    notifyItemChanged(parentPosition)
    ...
    private fun setScanDataOnItem(
        arrayList: ArrayList<RFPResponse.Value>,
        itemCode: String
    ): Int {

        var position = -1
        for ((index, item) in arrayList.withIndex()) {
            if (item is RFPResponse.Value && item.ItemNo == itemCode) {
                position = index
                break
            }
        }
                            ...
                            try {
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    if (responseModel.value.size > 0) {
                                        ...
                                        itemPo =
                                            setScanDataOnItem(list, responseModel.value[0].ItemCode)
                                        Log.e("ItemPo==>", "" + itemPo)
                                    }
                        ...
                        override fun onResponse(
                            ...
                            try {
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    var responseModel = response.body()!!
                                    if (!responseModel.value.isNullOrEmpty() && !responseModel.value[0].Quantity.isNullOrEmpty() && !responseModel.value[0].Quantity.equals(
                                            "0.0"
                                        )
                                    ) {

                                        var Quantity =
                                            responseModel.value[0].Quantity.toDoubleOrNull()
                                        var RemainingOpenQuantity =
                                            list[itemPo].RemainingOpenQuantity.toDoubleOrNull()
                                        ...
                                        if (Quantity!! > RemainingOpenQuantity!!) {
                                            ...
                                            globalQtyList_gl["Item$position"] =
                                                ArrayList(stringList)


                                            tvTotalScannQty.text = ":   ${
                                                GlobalMethods.sumBatchQuantity(
                                                    position,
                                                    stringList
                                                )
                                            }"
                                            ...
                                            if (stringList.isNotEmpty() && !stringList.contains("0")) {
                                                ...
                                                batchItemsAdapter = BatchItemsAdapter(
                                                    ...
                                                    val listCopy =
                                                        globalQtyList_gl["Item$pos"]?.map { it }
                                                            ?: emptyList()
...
//                                                    val mapValue = listCopy.firstOrNull()?.toDoubleOrNull()?.toInt()
                                                    ...
                                                    if (!QUANTITYVAL.isNullOrEmpty()) {
                                                        ...
                                                        val list =
                                                            quantityHashMap["Item$position"]?.toMutableList()
                                                                ?: mutableListOf()
                                                ...
                                                batchItemsAdapter?.setOnDeleteItemClickListener(this@RFPItemAdapter)
                                                rvBatchItems.adapter = batchItemsAdapter
...
//                                            globalQtyList_gl.put("Item" + position, stringList)
                                            ...
                                            if (stringList.isNotEmpty() && !stringList.contains("0")) {
                                                ...
                                                batchItemsAdapter = BatchItemsAdapter(
                                                    ...
                                                    val listCopy =
                                                        globalQtyList_gl["Item$position"]?.map { it }
                                                            ?: emptyList()
//                                                    val mapValue = listCopy.firstOrNull()?.toDoubleOrNull()?.toInt()
                                                    ...
                                                    if (!QUANTITYVAL.isNullOrEmpty()) {
                                                        if (RemainingOpenQuantity != null && value > RemainingOpenQuantity) {
                                                            GlobalMethods.showError(
                                                                context,
                                                                "Value cannot exceed then Open Quantity"
                                                            )
...
//            .setMessage("Do you want to proceed?")
        ...
        layoutParams?.width =
            WindowManager.LayoutParams.MATCH_PARENT // Set the width to match parent
        layoutParams?.height =
            WindowManager.LayoutParams.WRAP_CONTENT // Set the height to wrap content
    ...
    private fun getQuantityForSuggestion(
        ...
        if (networkConnection.getConnectivityStatusBoolean(context)) {
            ...
            networkClient.getQuantityForSuggestion(
                ...
                remQt,
                itemCode,
                list.get(position).WarehouseCode
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    if (responseModel.value.size > 0 && !responseModel.value.isNullOrEmpty()) {
                                        if (responseModel.value[0].Quantity.toString().trim()
                                            ...
                                            Log.e(
                                                "Okh Remove",
                                                quantityHashMap.get("Item" + position)?.size.toString()
                                            )
                                        ...
                                        if (responseModel.value.size > 0 && !responseModel.value.isNullOrEmpty()) {
                                            ...
                                            if (!itemList_gl.isNullOrEmpty()) {
                                                ...
                                                tvTotalScannQty.text =
                                                    ":   " + GlobalMethods.sumBatchQuantity(
                                                        position,
                                                        serialQuantityHashMap.get("Item" + position)!!
                                                    ).toString()
                                                ...
                                                Log.e(
                                                    "batchQuantityList-->",
                                                    hashmapBatchQuantityList.toString()
                                                )
                                                Log.e(
                                                    "serialQuantity-->",
                                                    serialQuantityHashMap.toString()
                                                )
...
//                            else {
                            ...
                            val list = noneQuantityHashMap["Item$position"]?.toMutableList()
                                ?: mutableListOf()
                            ...
                            tvTotalScannQty.text =
                                ":   ${GlobalMethods.sumBatchQuantity(pos, list)}"
...
//                            }
            ...
            if (tvTotalScanGW.text.equals("Batch")) {
                ...
                if (tvTotalScanGW.text.isEmpty()) {
                    ...
                    GlobalMethods.showMessage(
                        context,
                        "Scan Type is " + tvTotalScanGW.text.toString()
                    )
                }
            }
    ...
    private fun openDynamicFieldsDialog(
        context: Context,
        po: Int,
        tvTotalScannQty: TextView,
        ...
        if (list[po].BinManaged.equals("N", true)) {
            ...
            val binAbs = if (list[po].BinABSEntry.isNullOrBlank()) {
                emptyList()
            } else {
                list[po].BinABSEntry.split(",").map { it.trim() }
            }

            val binLocationList = if (binLocations.isNullOrBlank()) {
                emptyList()
            } else {
                binLocations.split(",").map { it.trim() }
            }
            if (binAbs.isEmpty()) {
                setFieldAdapters(
                    context,
        ...
        btnSave.setOnClickListener {
            ...
            val myArrayList = ArrayList<RFPResponse.binAllocationJSONs>()
            var totalQty = 0.0;
    ...
    private fun setFieldAdapters(
        context: Context,
        warehouseCode: String,
        rvDynamicField: RecyclerView,
        binLocationList: List<String>,
        scanType: String,
        binManaged: String,
        binAbs: List<String>
    ) {
        rvDynamicField.apply {
            ...
            adapterFields = DynamicFieldRFPAdapter(
                context, warehouseCode, binLocationList, binAbs,
                binLocation,
