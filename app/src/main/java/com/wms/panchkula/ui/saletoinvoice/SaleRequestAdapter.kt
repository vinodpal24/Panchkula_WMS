...
class SaleRequestAdapter(var list: ArrayList<PurchaseRequestModel.Value>) :
    RecyclerView.Adapter<SaleRequestAdapter.ViewHolder>() {

    //TODO comment interface declare...
    private var onItemClickListener: ((List<PurchaseRequestModel.Value>, pos: Int) -> Unit)? = null
    ...
    fun OnItemClickListener(listener: (List<PurchaseRequestModel.Value>, pos: Int) -> Unit) {
