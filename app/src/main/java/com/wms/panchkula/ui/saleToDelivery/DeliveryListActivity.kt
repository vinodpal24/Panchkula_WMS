...
class DeliveryListActivity : AppCompatActivity() {
    ...
    private var requestAdapter: DeliveryRequestAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent?.let {
            ...
            if(flag==AppConstants.SALE_TO_DELIVERY){
                title = "Sales Delivery Order"
            }
            Log.i("TITLE","Flag: $flag ($title)")
        }
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    if (!productionList_gl.isNullOrEmpty() && productionList_gl.size > 0) {
                                        ...
                                        if (requestListModel_gl.size == 0) {
                                            Toast.makeText(this@DeliveryListActivity, "No New Transfer Requests Found", Toast.LENGTH_SHORT).show()
                                        }
                                    ...
                                    try {
                                        ...
                                        if (mError.error.code == 400) {
                                            GlobalMethods.showError(this@DeliveryListActivity, mError.error.message.value)
                                        }
                                        if (mError.error.code == 306 && mError.error.message.value != null) {
                                            GlobalMethods.showError(this@DeliveryListActivity, mError.error.message.value)
                                            val mainIntent = Intent(this@DeliveryListActivity, LoginActivity::class.java)
    ...
    private fun setInvoiceOrderAdapter() {
        ...
        requestAdapter = DeliveryRequestAdapter(requestListModel_gl)
        ...
        requestAdapter?.OnItemClickListener { list, pos ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                var intent: Intent = Intent(this@DeliveryListActivity, DeliveryDraftDocumentLinesActivity::class.java)
                ...
                if (productionValueList.size > 0) {
                    sessionManagement.setWarehouseCode(this@DeliveryListActivity, productionValueList[0].WarehouseCode)
                    Log.e("warehouse", "onCreate: " + sessionManagement.getWarehouseCode(this@DeliveryListActivity))
                }
