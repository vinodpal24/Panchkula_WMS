...
class PickListActivity : AppCompatActivity(){
    ...
    private var requestAdapter: PickListAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        materialProgressDialog = MaterialProgressDialog(this@PickListActivity)
        checkNetwoorkConnection = CheckNetwoorkConnection(application)
        sessionManagement = SessionManagement(this@PickListActivity)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        val searchView = SearchView((this@PickListActivity).supportActionBar!!.themedContext)
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    if (!productionList_gl.isNullOrEmpty() && productionList_gl.size > 0) {
                                        ...
                                        if (requestListModel_gl.size == 0) {
                                            Toast.makeText(this@PickListActivity, "No New Transfer Requests Found", Toast.LENGTH_SHORT).show()
                                        }
                                    ...
                                    try {
                                        ...
                                        if (mError.error.code == 400) {
                                            GlobalMethods.showError(this@PickListActivity, mError.error.message.value)
                                        }
                                        if (mError.error.code == 306 && mError.error.message.value != null) {
                                            GlobalMethods.showError(this@PickListActivity, mError.error.message.value)
                                            val mainIntent = Intent(this@PickListActivity, LoginActivity::class.java)
    ...
    private fun setInvoiceOrderAdapter() {
        ...
        requestAdapter = PickListAdapter(requestListModel_gl)
        ...
        requestAdapter?.OnItemClickListener { list, pos ->
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                var intent: Intent = Intent(this@PickListActivity, PickListTransferLinesActivity::class.java)
              ...
              //  intent.putExtra("numAtCard",itemObject.NumAtCard )
                ...
                if (productionValueList.size > 0) {
                    sessionManagement.setWarehouseCode(this@PickListActivity, productionValueList[0].WarehouseCode)
                    Log.e("warehouse", "onCreate: "+sessionManagement.getWarehouseCode(this@PickListActivity) )
                }
